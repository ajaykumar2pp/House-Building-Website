...
!function(t) {
    ...
    function g(t, n, r) {
        ...
        if (!e(i = "min" === t ? 0 : "max" === t ? 100 : parseFloat(t)) || !e(n[0]))
    ...
    function P(t, n) {
        ...
        if (0 !== n && (t.margin = t.spectrum.getMargin(n),
        !t.margin))
    ...
    function O(t, n) {
        ...
        if (t.limit = t.spectrum.getMargin(n),
        !t.limit)
    ...
    function V(e, f) {
        var d, p, h, m, g = e, v = [-1, -1], b = f.spectrum, w = [], x = {}, y = ["target", "base", "origin", "handle", "horizontal", "vertical", "background", "connect", "ltr", "rtl", "draggable", "", "state-drag", "", "state-tap", "active", "", "stacking", "tooltip", "", "pips", "marker", "value"].map((m = f.cssPrefix || l,
        function(t) {
            return m + t
        }
        ));
        ...
        function E(t, e) {
            if (!f.tooltips[e])
                return !1;
            var n = document.createElement("div");
            return n.className = y[18],
            t.firstChild.appendChild(n)
        }
        function N(t, e, n) {
            ...
            Object.keys(t).forEach(function(r) {
                ...
                o[1] && (a += "<div " + s(i, y[22], o) + ">" + n.to(o[0]) + "</div>")
            }),
            i.innerHTML = a,
            i
        }
        function M(t) {
            var e = t.mode
              ...
              , o = function(t, e, n) {
                var r, i = b.direction, o = {}, a = b.xVal[0], s = b.xVal[b.xVal.length - 1], u = !1, c = !1, l = 0;
                ...
                n.forEach(function(r, i) {
                    var a, s, f, d, p, h, m, g, v, w = r, x = n[i + 1];
                    if ("steps" === e && (a = b.xNumSteps[i]),
                    a || (a = x - w),
                    !1 !== w && void 0 !== x)
                        for (s = w; s <= x; s = (s + a).toFixed(7) / 1) {
                            for (m = (p = (d = b.toStepping(s)) - l) / t,
                            v = p / (g = Math.round(m)),
                            f = 1; f <= g; f += 1)
        ...
        function L(t, e, n, r) {
            var i = function(e) {
                return !g.hasAttribute("disabled") && (i = g,
                o = y[14],
                (i.classList ? !i.classList.contains(o) : !new RegExp("\\b" + o + "\\b").test(i.className)) && (e = function(t, e) {
                    t.preventDefault();
                    var n, r, i = 0 === t.type.indexOf("touch"), o = 0 === t.type.indexOf("mouse"), a = 0 === t.type.indexOf("pointer"), u = t;
                    return 0 === t.type.indexOf("MSPointer") && (a = !0),
                    i && (n = t.changedTouches[0].pageX,
                ...
                !(t === c.start && void 0 !== e.buttons && e.buttons > 1) && ((!r.hover || !e.buttons) && (e.calcPoint = e.points[f.ort],
                void n(e, r)))));
                var i, o
            }
              , o = [];
        ...
        function j(t, e) {
            if (-1 === navigator.appVersion.indexOf("MSIE 9") && 0 === t.buttons && 0 !== e.buttonsProperty)
                return k(t, e);
            var n, i, o, a, s, u, c, l = e.handles || p, f = !1, d = 100 * (t.calcPoint - e.start) / e.baseSize, h = l[0] === p[0] ? 0 : 1;
            if (o = d,
            a = e.positions,
            s = l.length > 1,
            u = o + a[0],
            c = o + a[1],
            n = s ? (u < 0 && (c += Math.abs(u)),
            c > 100 && (u -= c - 100),
            [r(u), r(c)]) : [u, c],
            f = q(l[0], n[h], 1 === l.length),
            l.length > 1) {
                if (f = q(l[1], n[h ? 0 : 1], !1) || f)
                    for (i = 0; i < e.handles.length; i++)
                        P("slide", i)
            } else
                f && P("slide", h)
        }
        ...
        function F(t, e) {
            ...
            if (1 === e.handles.length && (o(e.handles[0].children[0], y[15]),
            ...
            if (n.noUiListeners = r.concat(i, a),
            t.cursor) {
        ...
        function q(t, e, n) {
            var i = t !== p[0] ? 1 : 0
              ...
              , c = v[0] + f.limit
              , l = v[1] - f.limit;
            return p.length > 1 && (e = i ? Math.max(e, s) : Math.min(e, u)),
            !1 !== n && f.limit && p.length > 1 && (e = i ? Math.min(e, c) : Math.max(e, l)),
            e = b.getStep(e),
            (e = r(parseFloat(e.toFixed(7)))) !== v[i] && (window.requestAnimationFrame ? window.requestAnimationFrame(function() {
                t.style[f.style] = e + "%"
            }) : t.style[f.style] = e + "%",
            t.previousSibling || (a(t, y[17]),
            e > 50 && o(t, y[17])),
            v[i] = e,
        ...
        function z(t) {
            var e, r, o = i(t);
            for (f.dir && f.handles > 1 && o.reverse(),
            ...
            function(t, e) {
                ...
                for (f.limit && (t += 1),
                n = 0; n < t; n += 1)
                    null !== (i = e[r = n % 2]) && !1 !== i && ("number" == typeof i && (i = String(i)),
                    (!1 === (i = f.format.from(i)) || isNaN(i) || !1 === q(p[r], b.toStepping(i), n === 3 - f.dir)) && P("update", r))
            }(e, o),
            r = 0; r < p.length; r++)
                null !== o[r] && P("set", r)
        }
        ...
        h = {
            ...
            steps: function() {
                return O(v.map(function(t, e) {
                    var n, r, i = b.getApplicableStep(t), o = (n = String(i[2]),
                    (r = n.split(".")).length > 1 ? r[1].length : 0), a = w[e], s = 100 === t ? null : i[2], u = Number((a - i[2]).toFixed(o));
        ...
        function(t) {
            ...
            t.drag && (o((n = [d.querySelector("." + y[7])])[0], y[10]),
...
function() {
    ...
    function o(t, n, r, o, a, s, u, c, l, f, d, p) {
        var h, m, g, v = p, b = "", w = "";
        return s && (p = s(p)),
        !!i(p) && (!1 !== t && 0 === parseFloat(p.toFixed(t)) && (p = 0),
        p < 0 && (h = !0,
        p = Math.abs(p)),
        !1 !== t && (p = function(t, e) {
            var n = Math.pow(10, e);
        ...
        -1 !== (p = p.toString()).indexOf(".") ? (g = (m = p.split("."))[0],
        r && (b = r + m[1])) : g = p,
        n && (g = e(g).match(/.{1,3}/g),
        g = e(g.join(e(n)))),
        h && c && (w += c),
    ...
    function a(t, e, r, o, a, s, u, c, l, f, d, p) {
        var h, m = "";
        return d && (p = d(p)),
        !(!p || "string" != typeof p) && (c && n(p, c) && (p = p.replace(c, ""),
        h = !0),
        o && n(p, o) && (p = p.replace(o, "")),
        l && n(p, l) && (p = p.replace(l, ""),
        h = !0),
        a && function(t, e) {
            return t.slice(-1 * e.length) === e
        }(p, a) && (p = p.slice(0, -1 * a.length)),
        e && (p = p.split(e).join("")),
        r && (p = p.replace(r, ".")),
        h && (m += "-"),
        "" !== (m = (m += p).replace(/[^0-9\.\-.]/g, "")) && (m = Number(m),
        u && (m = u(m)),
        !!i(m) && m))
    }
    function s(e, n, r) {
    ...
    window.wNumb = function e(n) {
        ...
        "object" == typeof n && (n = function(e) {
            ...
            for (n = 0; n < t.length; n += 1)
                if (void 0 === (o = e[i = t[n]]))
                    "negative" !== i || a.negativeBefore ? "mark" === i && "." !== a.thousand ? a[i] = "." : a[i] = !1 : a[i] = "-";
                else if ("decimals" === i) {
                    if (!(o >= 0 && o < 8))
                        throw new Error(i);
                    a[i] = o
